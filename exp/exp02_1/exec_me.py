...
non_img_extr = ResNet18Extractor(in_features=948, out_features=200, num_classes=6, dropout_p=0).to(dev)
...
reporter.set_experiment_name("CrossModal fMRI extractor Full-ResNet18")
reporter.append_summary_description(
    "Using fMRI extractor as Full-ResNet18, no dropout is used.")
reporter.append_summary_description("I just want to see the performance of ResNet18.")
