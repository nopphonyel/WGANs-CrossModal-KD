...
reporter.set_experiment_name("KD on 3LayersGenerator - 2stAT+Discrim Loss")
reporter.set_summary_description("Using the second feature layer for calculating AT_KD loss")
...
try:
    for e in range(EPOCHS):
        ...
        for i, (fmri, img, lab) in enumerate(ld):
            ...
            kd_loss_lg.collect_step('at_l2', kd_loss_at_val[0].item())
