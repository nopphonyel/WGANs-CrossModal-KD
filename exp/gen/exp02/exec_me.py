...
netG = wgans_kd.GeneratorDeptSep(ngpu=1, num_classes=num_classes, z_dim=z_dim, latent_size=200, img_channel=1).to(dev)
...
try:
    ...
    reporter.stop()
    reporter.write_summary(os.path.dirname(__file__), f_name="summary_gen_deptsep.txt")
