            ...
            for fmri_val, img_val, label_idx_val in ld_val:
                ...
                if i == 0 and (e + 1) % FID_CALC_FREQ == 0:
                    ...
                    if best['FIDIncep'] is None or best['FIDIncep'] > fid_score:
                        ...
                        reporter.log("  > Exporting Generator: netG_3layers.pth")
                        save_model(netG, MODEL_PATH, "netG_3layers.pth")

                        reporter.log("  > Exporting Discriminator: netD_3layers.pth")
                        save_model(netD, MODEL_PATH, "netD_3layers.pth")

                        reporter.log("  > Exporting Non-image FE: non_img_extr_3layers.pth")
                        save_model(non_img_extr, MODEL_PATH, "non_img_extr_3layers.pth")
